...
constexpr uint8_t GPS_CFG_ENABLE_VTG[GPS_CFG_DENMEA_MSGL] = { 0xB5, 0x62, 0x06, 0x01, 0x03, 0x00, 0xF0, 0x05, 0x01, 0x00, 0x1A }; //enable VTG messages
constexpr uint8_t GPS_CFG_ENABLE_GNS[GPS_CFG_DENMEA_MSGL] = { 0xB5, 0x62, 0x06, 0x01, 0x03, 0x00, 0xF0, 0x0D, 0x01, 0x08, 0x2A }; //enable GNS messages
constexpr uint8_t GPS_CFG_ENABLE_GSA[GPS_CFG_DENMEA_MSGL] = { 0xB5, 0x62, 0x06, 0x01, 0x03, 0x00, 0xF0, 0x02, 0x01, 0xFD, 0x14 }; //enable GSA messages
